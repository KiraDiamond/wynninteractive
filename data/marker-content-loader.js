const LIMITED_MARKER_FALLBACK = {
  ...
  explanation:
    "There isn't much public information regarding this marker right now. When wiki.gg gets a dedicated page related to it, we'll add more here.",
};

export const MANUAL_MARKER_OVERRIDES = {
  "atlas-quests-the-qira-hive-372--5501": {
    sourceUrl: "https://wynncraft.wiki.gg/wiki/The_Qira_Hive_(Quest)",
    links: [
      {
        label: "Qira phase guide",
        url: "https://forums.wynncraft.com/threads/an-in-depth-guide-to-fighting-qira.291617/",
      },
  ...
  "qira-hive-thunder": {
    summary:
      "First elemental wing. Clear the Thunder floors, bank five catalysts per floor, and finish on Psychomancer for Thunder Catalyst X.",
    explanation:
    ...
    sourceUrl: "https://wynncraft.wiki.gg/wiki/The_Qira_Hive_(Quest)",
    links: [{ label: "Hive mob list", url: "https://wynncraft.fandom.com/wiki/Lists_of_mobs/The_Qira_Hive" }],
  },
  "qira-hive-air": {
  ...
  "qira-hive-earth": {
    summary:
      "Third elemental wing. The Earth path is slower, heavier, and full of chained phase mobs before Genemorph.",
    explanation:
  ...
  "qira-hive-water": {
    summary:
      "Fourth elemental wing. The Water route is built around control effects, teleports, and a hard judge fight at the end.",
    explanation:
  ...
  "qira-hive-qira": {
    summary:
      "Master Division boss room. Once every voucher is cleared, this is the three-phase Qira fight that ends the hive.",
    explanation:
  ...
  "atlas-secret-discovery-ragni-s-secret-library--933--1610": { tutorials: ["https://www.youtube.com/shorts/pVfKL5gymT0"] },
  "atlas-secret-discovery-far-from-the-roots--500--1630": { tutorials: ["https://www.youtube.com/shorts/nLOzauew_OA"] },
  "atlas-secret-discovery-a-hero-s-origin--872--1978": { tutorials: ["https://www.youtube.com/shorts/umCtab3mPDY"] },
  "atlas-secret-discovery-watchmen--279--1583": { tutorials: ["https://www.youtube.com/shorts/Vx_8FFUS9OQ"] },
  "atlas-secret-discovery-boulder-breaker-310--1460": { tutorials: ["https://www.youtube.com/shorts/UbGERvMDXrA"] },
  "atlas-secret-discovery-historical-maltic--560--1858": { tutorials: ["https://www.youtube.com/shorts/pbV_7vX5XyY"] },
  "atlas-secret-discovery-ruins-of-detlas-435--1574": { tutorials: ["https://www.youtube.com/shorts/Yta8UaxnJWM"] },
  "atlas-secret-discovery-water-of-the-past--303--1887": { tutorials: ["https://www.youtube.com/shorts/1HIKAf6Y9iU"] },
  "atlas-secret-discovery-bak-al-s-destruction-1--123--1288": { tutorials: ["https://www.youtube.com/shorts/mFgVTkHB_4I"] },
  "atlas-secret-discovery-bak-al-s-destruction-2-120--1535": { tutorials: ["https://www.youtube.com/shorts/HWLyCTcCscc"] },
  "atlas-secret-discovery-bak-al-s-destruction-3--744--1960": { tutorials: ["https://www.youtube.com/shorts/_3G8o-Edh9U"] },
  "atlas-secret-discovery-timeless-ruin--509--1061": { tutorials: ["https://www.youtube.com/shorts/1uq6cO92jPY"] },
  "atlas-secret-discovery-beneath-the-roots-26--1312": { tutorials: ["https://www.youtube.com/shorts/CnTfldxmQ_w"] },
  "atlas-secret-discovery-somewhere-in-between--732--1270": { tutorials: ["https://www.youtube.com/shorts/lvaN9mjDN_4"] },
  "atlas-quests-acquiring-credentials--256--4983": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Acquiring_Credentials" },
  "atlas-quests-aldorei-s-secret-part-i--462--4460": {
    sourceUrl: "https://wynncraft.wiki.gg/wiki/Aldorei's_Secret_Part_I",
  },
  "atlas-quests-an-iron-heart-part-i--1613--4964": { sourceUrl: "https://wynncraft.wiki.gg/wiki/An_Iron_Heart_Part_I" },
  "atlas-quests-an-iron-heart-part-ii--1745--5479": {
    sourceUrl: "https://wynncraft.wiki.gg/wiki/An_Iron_Heart_Part_II",
  },
  "atlas-quests-from-the-mountains--1366--4543": { sourceUrl: "https://wynncraft.wiki.gg/wiki/From_the_Mountains" },
  "atlas-quests-lazarus-pit--1025--5302": {
    summary:
      "Level 69 quest in Gelibord. Defend the town, investigate the Lazarus Pit legend, solve the crypt graves, then cut the pit off from the river.",
    explanation:
  ...
  "atlas-quests-out-of-my-mind--860--961": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Out_of_my_Mind" },
  "atlas-quests-reclaiming-the-house--1499--5349": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Reclaiming_the_House" },
  "atlas-quests-stable-story-561--1598": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Stable_Story" },
  "atlas-quests-star-thief--2018--4822": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Star_Thief" },
  "atlas-quests-the-ultimate-weapon--947--4593": { sourceUrl: "https://wynncraft.wiki.gg/wiki/The_Ultimate_Weapon" },
  "atlas-quests-underice-157--812": { sourceUrl: "https://wynncraft.wiki.gg/wiki/Underice" },
  "atlas-quests-true-colours--1372--563": { tutorials: ["https://youtu.be/JyIDve2iKng?si=urOI4IJDqUfcCNki"] },
  "atlas-world_discovery-light-s-secret--1050--4295": {
    summary:
      "Hidden light gateway beneath the Light Forest. This discovery marks the concealed entrance used to reach the Realm of Light from Gavel.",
    explanation:
  ...
  "atlas-world_discovery-tol-altar-529--457": {
    summary:
      "Olmic Tol Altar. This altar upgrades lower-tier runes into Tol runes once you reach the Olmic Cathedral route.",
    explanation:
  ...
  "atlas-world_discovery-tol-altar-1431--4634": {
    summary:
      "Sky Islands Tol Altar. This is the second Tol conversion point for turning lower-tier runes into Tol runes during Sky routes.",
    explanation:
  ...
  "atlas-world_discovery-uth-shrine--1911--3235": {
    ...
    links: [
      {
        label: "Uth guardian notes",
        url: "https://forums.wynncraft.com/threads/uth-runes-uth-guardians-because-i-got-bored.243575/",
      },
    ],
  },
  "atlas-world_discovery-uth-shrine--215--4460": {
    summary:
      "Ocean-side Uth Shrine. Offer a Golden Avia Feather here to trigger the Uth Guardians and cash out for Uth runes.",
    explanation:
...
export function contentSourceKeyForCategory(categoryId) {
  ...
  if (String(categoryId || "").startsWith("profession_")) {
    return "profession";
  }
  ...
  return (
    {
      quests: "quests",
      mini_quests: "mini-quests",
      secret_discovery: "secret-discoveries",
      world_discovery: "world-discoveries",
      world_events: "world-events",
      dungeon: "dungeons",
      raid: "raids",
      boss_altar: "boss-altars",
      caves: "caves",
      lootrun_camp: "lootrun-camps",
      fast_travel: "fast-travel",
      seaskipper: "seaskippers",
    }[categoryId] || null
  );
}

export function manualMarkerContentEntry(markerId) {
